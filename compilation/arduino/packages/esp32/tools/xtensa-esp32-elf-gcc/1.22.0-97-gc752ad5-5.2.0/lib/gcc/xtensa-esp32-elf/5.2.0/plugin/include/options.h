...
#define MASK_ESP32_ALWAYS_MEMBARRIER (1 << 0)
#define MASK_AUTO_LITPOOLS (1 << 1)
#define MASK_CONST16 (1 << 2)
#define MASK_ESP32_PSRAM_FIX_ENA (1 << 3)
...
enum opt_code
{
  ...
  OPT_mfix_esp32_psram_cache_strategy_ = 1140,/* -mfix-esp32-psram-cache-strategy= */
  OPT_mforce_no_pic = 1141,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1142, */              /* -mfused-madd */
  OPT_mlongcalls = 1143,                     /* -mlongcalls */
  OPT_mserialize_volatile = 1144,            /* -mserialize-volatile */
  OPT_mtarget_align = 1145,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1146,         /* -mtext-section-literals */
  OPT_n = 1147,                              /* -n */
  ...
  OPT_r = 1176,                              /* -r */
  OPT_rdynamic = 1177,                       /* -rdynamic */
  OPT_remap = 1178,                          /* -remap */
  OPT_s = 1179,                              /* -s */
  OPT_s_bc_abi = 1180,                       /* -s-bc-abi */
  OPT_save_temps = 1181,                     /* -save-temps */
  OPT_save_temps_ = 1182,                    /* -save-temps= */
  OPT_shared = 1183,                         /* -shared */
  OPT_shared_libgcc = 1184,                  /* -shared-libgcc */
  /* OPT_specs = 1185, */                    /* -specs */
  OPT_specs_ = 1186,                         /* -specs= */
  OPT_static = 1187,                         /* -static */
  OPT_static_libasan = 1188,                 /* -static-libasan */
  OPT_static_libgcc = 1189,                  /* -static-libgcc */
  OPT_static_libgcj = 1190,                  /* -static-libgcj */
  OPT_static_libgfortran = 1191,             /* -static-libgfortran */
  OPT_static_libgo = 1192,                   /* -static-libgo */
  OPT_static_liblsan = 1193,                 /* -static-liblsan */
  OPT_static_libmpx = 1194,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1195,          /* -static-libmpxwrappers */
  ...
  /* OPT_std_c__17 = 1203, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1204, */                /* -std=c++1y */
  OPT_std_c__1z = 1205,                      /* -std=c++1z */
  ...
  /* OPT_std_gnu__17 = 1222, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1223, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1224,                    /* -std=gnu++1z */

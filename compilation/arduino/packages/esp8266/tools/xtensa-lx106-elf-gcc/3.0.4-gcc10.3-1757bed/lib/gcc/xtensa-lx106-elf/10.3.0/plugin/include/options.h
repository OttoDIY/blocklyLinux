...
#define MASK_FORCE_L32 (1U << 2)
#define MASK_FORCE_NO_PIC (1U << 3)
#define MASK_SERIALIZE_VOLATILE (1U << 4)
...
#define TARGET_FORCE_L32_P(target_flags) (((target_flags) & MASK_FORCE_L32) != 0)
...
enum opt_code
{
  ...
  OPT_list = 1595,                           /* -list */
  OPT_mauto_litpools = 1596,                 /* -mauto-litpools */
  OPT_mconst16 = 1597,                       /* -mconst16 */
  OPT_mforce_l32 = 1598,                     /* -mforce-l32 */
  OPT_mforce_no_pic = 1599,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1600, */              /* -mfused-madd */
  OPT_mlongcalls = 1601,                     /* -mlongcalls */
  OPT_mserialize_volatile = 1602,            /* -mserialize-volatile */
  OPT_mtarget_align = 1603,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1604,         /* -mtext-section-literals */
  OPT_n = 1605,                              /* -n */
  OPT_name_sort = 1606,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1607,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1608,              /* -no-integrated-cpp */
  OPT_no_pie = 1609,                         /* -no-pie */
  OPT_nocpp = 1610,                          /* -nocpp */
  OPT_nodefaultlibs = 1611,                  /* -nodefaultlibs */
  OPT_nolibc = 1612,                         /* -nolibc */
  OPT_nophoboslib = 1613,                    /* -nophoboslib */
  OPT_nostartfiles = 1614,                   /* -nostartfiles */
  OPT_nostdinc = 1615,                       /* -nostdinc */
  OPT_nostdinc__ = 1616,                     /* -nostdinc++ */
  OPT_nostdlib = 1617,                       /* -nostdlib */
  OPT_o = 1618,                              /* -o */
  OPT_objects = 1619,                        /* -objects */
  OPT_p = 1620,                              /* -p */
  OPT_pass_exit_codes = 1621,                /* -pass-exit-codes */
  /* OPT_pedantic = 1622, */                 /* -pedantic */
  OPT_pedantic_errors = 1623,                /* -pedantic-errors */
  OPT_pg = 1624,                             /* -pg */
  OPT_pie = 1625,                            /* -pie */
  OPT_pipe = 1626,                           /* -pipe */
  OPT_print_file_name_ = 1627,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1628,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1629,          /* -print-multi-directory */
  OPT_print_multi_lib = 1630,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1631,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1632,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1633,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1634,               /* -print-prog-name= */
  OPT_print_search_dirs = 1635,              /* -print-search-dirs */
  OPT_print_sysroot = 1636,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1637,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1638,                    /* -print-value */
  OPT_quiet = 1639,                          /* -quiet */
  OPT_r = 1640,                              /* -r */
  OPT_rdynamic = 1641,                       /* -rdynamic */
